...
export default function PostsManager() {
  ...
  // Add these states after other useState declarations (around line 65):
  ...
  const [availableThumbnails] = useState([
    ...
    // Add more event highlight thumbnails as needed
  ]);
  // Fetch posts
  ...
  // Update the handleFileDrop function (around line 180):
  const handleFileDrop = (files: File[]) => {
    if (files.length > 0) {
      ...
      setFormData(prev => ({ 
        ...prev, 
        mediaType: fileType,
        // Clear thumbnail when new file is selected
      ...
      // Show thumbnail selector for videos
      if (fileType === 'video') {
  ...
  const removeSelectedFile = () => {
    ...
    setPreviewUrl('');
    // Clear mediaUrl when removing file
  ...
  const handleSave = async () => {
    try {
      ...
      // Upload new file if selected, otherwise keep existing URL
      if (selectedFile) {
  ...
  const resetForm = () => {
    ...
    setIsCreating(false);
    setEditingId(null);
    // Clear existing media preview when creating new post
    if (!editingId) {
      setPreviewUrl('');
    }
  };
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          <h2 className="text-2xl font-bold text-pink-900">Posts Management</h2>
          <p className="text-pink-700">Drag posts to reorder • Auto-saves order changes</p>
        </div>
        <Button
      ...
      {previewPost && (
        <Card className="border-blue-200 bg-blue-50">
          <CardHeader>
            ...
            <CardDescription>How this post looks on the main website</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="bg-white rounded-lg p-6">
              <div className="flex flex-col md:flex-row gap-4">
                ...
                <div className="w-full md:w-1/2 bg-pink-100 p-6 rounded-lg">
                  <h3 className="text-xl font-bold mb-3 text-pink-800">{previewPost.title_en}</h3>
                  <p className="text-pink-700 mb-4">{previewPost.description_en}</p>
                  {previewPost.eventPageSlug && (
                    <div className="inline-block bg-pink-500 text-white px-4 py-2 rounded-lg">
                      Know More...
                    </div>
                  )}
                </div>
      ...
      {isCreating && (
        <Card className="border-pink-200">
          ...
          <CardContent className="space-y-6 pt-6">
            ...
            {/* Event Page Link */}
            <div className="space-y-2">
              <Label>Event Page Integration</Label>
              ...
              {formData.eventPageSlug && (
                <div className="space-y-3 p-4 bg-green-50 border border-green-200 rounded-lg">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="eventSlug" className="text-green-800">Event Page Slug (URL)</Label>
                    <Input
                      id="eventSlug"
                    ...
                    <p className="text-xs text-green-600">
                      📍 Event page URL will be: <code className="bg-green-100 px-1 rounded">/events/{formData.eventPageSlug}</code>
                    </p>
                  </div>
                        ...
                        <div className="flex items-start gap-4">
                          ...
                          <div className="flex-1">
                            <div className="flex items-center gap-2 mb-2">
                              ...
                              <h3 className="font-semibold text-pink-900">{post.title_en}</h3>
                              <Badge variant={post.isActive ? "default" : "secondary"} className="bg-pink-100 text-pink-800">
                            ...
                            <p className="text-sm text-gray-600 mb-2">{post.description_en}</p>
                          </div>
